      ...
      <div class="border-l-4 border-blue-500 pl-4 mt-12">
        ...
        >
          <form @submit.prevent="deletePost(post)">
            <button
              class="text-red-500 font-bold px-2 py-1 border border-red-300 cursor-pointer"
            >
              Delete
            </button>
          </form>
          ...
          <router-link
            ...
            class="text-green-500 font-bold px-2 py-1 border border-green-300 cursor-pointer"
            >Update</router-link
          >
        </div>
      </div>
